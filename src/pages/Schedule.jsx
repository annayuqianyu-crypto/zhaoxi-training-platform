...
function loadEvents() {
  try {
    ...
    return raw.map(ev => {
      // migrate old format (instructor was a free-text string, no type field)
...
export function Schedule() {
  ...
  function handleSave() {
    ...
    const updated = modal.mode === 'edit'
      ...
      : [...events, ev]
    saveEvents(updated); setEvents(updated); setModal(null)
  }
    ...
    <>
      ...
      <div className="content">
        ...
        <p style={{ fontSize: 11, color: 'var(--text-3)', marginTop: 14, textAlign: 'center' }}>
          点击日期格子添加排期 · 点击排期条目编辑或删除 · 所有视图实时同步
        </p>
      </div>
